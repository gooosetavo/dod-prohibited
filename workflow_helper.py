...
def check_for_changes():
    ...
    if has_changes:
        ...
        if total_changes == 0:
            print(
                "⚠️  Warning: Files changed but no meaningful substance changes detected"
            )
        ...
        changes_summary = (
            ", ".join(summary_parts) if summary_parts else "changes detected"
        )
        ...
        temp_summary_path = (
            ...
            else "changes_summary_temp.json"
        )
